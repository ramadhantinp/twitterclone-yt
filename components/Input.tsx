...
const Input: React.FC<InputProps> = ({placeholder, value, disabled, type, onChange}) => {
    return (
        <input
        disabled={disabled} onChange={onChange} value={value} placeholder={placeholder} type={type}
